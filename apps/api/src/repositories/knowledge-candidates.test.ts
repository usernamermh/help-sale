...
describe("knowledge candidates", () => {
	it("创建候选并列表", () => {
		...
		expect(listCandidates(db, "t1")).toHaveLength(1);
		expect(listCandidates(db, "t1", "approved")).toHaveLength(0);
	});
